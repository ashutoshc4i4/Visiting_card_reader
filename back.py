...
MONGO_USER = 'ashutoshshrivastava'
MONGO_PASSWORD = 'GvckKYjo2EQ8jCkJ'
MONGO_URI = f"mongodb+srv://{MONGO_USER}:{MONGO_PASSWORD}@cluster0.vqa7ne9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
